  ...
  return (
    <ResponsiveContainer width="100%" height="100%">
      <BarChart data={data} margin={{ top: 4, right: 4, bottom: 4, left: -24 }}>
        <XAxis dataKey="id" tick={{ fontSize: 8, fill: '#9ca3af' }} axisLine={false} tickLine={false} />
  ...
  return (
    <ResponsiveContainer width="100%" height="100%">
      <LineChart data={data} margin={{ top: 4, right: 4, bottom: 4, left: -24 }}>
        <XAxis dataKey="pct" tick={{ fontSize: 8, fill: '#9ca3af' }} axisLine={false} tickLine={false} />
        <YAxis tick={{ fontSize: 8, fill: '#9ca3af' }} axisLine={false} tickLine={false} />
  ...
  return (
    <ResponsiveContainer width="100%" height="100%">
      <ScatterChart margin={{ top: 4, right: 4, bottom: 4, left: -24 }}>
        <XAxis type="number" dataKey="x" tick={{ fontSize: 8, fill: '#9ca3af' }} axisLine={false} tickLine={false} domain={[25, 70]} />
        <YAxis type="number" dataKey="y" tick={{ fontSize: 8, fill: '#9ca3af' }} axisLine={false} tickLine={false} domain={[55, 100]} />
  ...
  return (
    <ResponsiveContainer width="100%" height="100%">
      <BarChart data={data} layout="vertical" margin={{ top: 4, right: 4, bottom: 4, left: 28 }}>
        <XAxis type="number" domain={[-1, 1]} tick={{ fontSize: 8, fill: '#9ca3af' }} axisLine={false} tickLine={false} />
        <YAxis type="category" dataKey="name" tick={{ fontSize: 8, fill: '#6b7280' }} axisLine={false} tickLine={false} width={32} />
